...
setwd("D:/TCD- ASDS/Applied Statistics 1/GitHub/StatsI_Fall2023")
getwd()
...
# **Standardized** residuals, (as this is required by Jeff)
...
#We can see a positive association
...
# Step 4: P-value
# Step 5: Conclusion
#p-value is <5% and so, we reject null or we can say there is sufficient evidence that the two vars are not independent.
...
# Step 2: Hypotheses: null = slope == 0
# Step 3: Test statistic
# Step 4: P-value
# Step 5: Conclusion: P-value < 5% and so reject null and can assume that 
#education has relation with income and with every 1 year increase in education, on average income increases by 250.
